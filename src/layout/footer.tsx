    ...
    <footer className="relative pt-10 lg:pt-10 bg-gray-50 border-t">
      <div className="max-w-7xl mx-auto px-8 ">
        <div className="flex flex-wrap -mx-4">
          <div className="w-full px-4 sm:w-3/3 lg:w-3/12">
            <div className="w-full mb-10">
              ...
              >
                ...
                <h2 className="text-2xl font-semibold italic">Soccer</h2>
              </Link>
          ...
          <div className="w-1/2 px-4 sm:w-1/4 lg:w-2/12">
            <div className="w-full mb-10">
              <h4 className="text-lg font-medium text-dark  mb-9">Resources</h4>
          ...
          <div className="w-1/2 px-4 sm:w-1/4 md:w-3/12 lg:w-2/12">
            <div className="w-full mb-10">
              <h4 className="text-lg font-medium text-dark  mb-9">Company</h4>
              <ul className="space-y-3 font-light">
                <li>
                  <Link
                    to="/"
          ...
          <div className="w-1/2 px-4 sm:w-1/4 lg:w-2/12">
            <div className="w-full mb-10">
              <h4 className="text-lg font-medium text-dark  mb-8">
                Quick Links
              </h4>
              <ul className="space-y-3 font-light">
                <li>
          ...
          <div className="w-1/2 px-4 sm:w-1/4 lg:w-3/12">
            <div className="w-full mb-10">
              <h4 className="text-lg font-medium text-dark  mb-8">
                Follow Us On
              </h4>
              <div className="flex items-center mb-6 font-light">
                <Link
                  to="/"
                  className="flex items-center justify-center w-8 h-8 mr-3 border rounded-full text-dark hover:border-primary hover:bg-primary border-stroke dark:border-dark-3 dark:hover:border-primary  hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                >
                  <svg
                    width="8"
                    height="16"
